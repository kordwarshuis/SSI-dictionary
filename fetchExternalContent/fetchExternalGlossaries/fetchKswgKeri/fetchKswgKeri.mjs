...
console.log('KSWG KERI: Fetching external content...');

// Config
const url = 'https://trustoverip.github.io/kswg-keri-specification/index.html';
const organisation = 'KSWG (KERI)';
const jsonFileName = 'terms-definitions-kswg-keri.json';
